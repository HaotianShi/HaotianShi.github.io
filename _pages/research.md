...
The rapid advancement of communication, vehicle automation technologies, and artificial intelligence (AI) is transforming intelligent transportation systems (ITS) and autonomous driving systems (ADS), offering opportunities to enhance safety, efficiency, and energy. Motivated by these developments, my research focuses on 1) interactive driving behavior modeling and prediction, 2) optimal control of connected and automated vehicles (CAVs) in mixed traffic environments, 3) traffic management, 4) human-machine interaction for autonomous driving, and 5) 3D scene generation and end-to-end AV testing. My research philosophy hinges on addressing challenges in these areas by integrating traditional analytical methods, such as physics-based modeling, control theory, and traffic flow theory, with emerging technologies like machine learning (ML) and foundation models (FMs). In line with my research philosophy, I have developed generic and interpretable methodological frameworks and computational models to analyze and improve transportation system performance in terms of mobility, safety, stability, and energy consumption. Several of the proposed methodologies are validated through ​Vehicle-in-the-Loop Test Bench​ and field implementations with Level-3 CAVs.

To support systematic experimentation and real-world evaluation of the above research, our TOPS lab is backed by the Ministry of Education Key Laboratory at Tongji University (College of Transportation Engineering) and has established a comprehensive suite of autonomous driving research equipments and platforms. These include multiple Level-3 CAVs, a driving simulator cluster for large-scale simulation experiments, a complete set of human factors data acquisition equipment, a full-vehicle-in-the-loop human–machine interaction platform, a virtual–real integrated autonomous driving testing platform, an autonomous driving domain-controller-in-the-loop platform, a Cave Automatic Virtual Environment (CAVE)-based immersive human-in-the-loop experimental platform, and an intelligent connected transportation proving ground at Tongji, collectively enabling systematic validation from algorithm development to real-world deployment. In addition, our TOPS lab has established the [OnSite](https://www.onsite.com.cn/#/dist/home) public autonomous driving testing service platform, providing standardized testing services for autonomous driving algorithms, and organized and hosted three editions of the OnSite Autonomous Driving Algorithm [Challenge](https://www.onsite.com.cn/#/dist/announcement3) to advance fundamental research in autonomous driving.

## Major Research Areas <br>
Over the years, I have investigated the following broad areas of research: 1) interactive driving behavior modeling and prediction, 2) optimal control of connected and automated vehicles (CAV) in mixed traffic environments, 3) traffic management, 4) human-machine interaction for autonomous driving, and 5) 3D scene generation and end-to-end AV testing.
...
### [Interaction Dataset of Autonomous Vehicles with Traffic Lights and Signs](https://www.sciencedirect.com/science/article/pii/S2772424725000411?via%3Dihub) (COMMTR, 2025)   
<p>
...
### [V2X-VLM: End-to-End V2X Cooperative Autonomous Driving Through Large Vision-Language Models](https://linkinghub.elsevier.com/retrieve/pii/S0968090X25004619) (TR-Part C, 2026)   
<p>
...
### [Recovering large-scale urban traffic flow data from sparse observations via analytical optimization](https://www.sciencedirect.com/science/article/pii/S1093968726031658?via%3Dihub) (CACAIE, 2026)  
<p>
